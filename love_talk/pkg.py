...
if __name__ == "__main__":
    ...
    directories = ["love_talk","llm_utils"]  # Replace with your list of directories to be included in the zip  
    files = ["love_talk_main.py", "version.txt", "deploy.txt",f"start_{app_name}.sh",'cmd.txt']      # Replace with your list of files to be included in the zip
