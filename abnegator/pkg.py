...
if __name__ == "__main__":
    ...
    directories = ['excel_operator', 'llm_utils', 'result_data', 'source_data']  # Replace with your list of directories to be included in the zip
    files = ["version.txt", "deploy.txt","excel_operator_start.sh","excel_operator_main.py","requirement.txt", 'cmd.txt']      # Replace with your list of files to be included in the zip
    target_zip_path = "excel_operator.zip"  # Replace with the desired output zip file path        
    
    create_zip(target_zip_path, directories, files) 
    
    shutil.copy(target_zip_path, f"dist/excel_operator_{version_info}.zip")